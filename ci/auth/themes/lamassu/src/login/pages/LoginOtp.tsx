                ...
                <div className={kcClsx("kcFormGroupClass")}>
                    ...
                    <div className={kcClsx("kcInputWrapperClass")}>
                        <OtpInput
                            ...
                            renderSeparator={<span style={{marginRight: "20px"}}/>}
                            inputStyle={{ border: "1px solid #eee", borderBottom: "3px solid #bbb", background:  "#ddd", width: "50px", height: "50px", fontSize: "25px", fontWeight: "600", outline: "none" }}
